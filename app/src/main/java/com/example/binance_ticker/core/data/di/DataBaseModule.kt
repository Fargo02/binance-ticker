package com.example.binance_ticker.core.data.di

import android.content.Context
import androidx.room.Room
import com.example.binance_ticker.core.data.datasource.local.LocalDataSource
import com.example.binance_ticker.core.data.datasource.local.RoomLocalDataSource
import com.example.binance_ticker.core.data.datasource.local.db.AppDatabase
import com.example.binance_ticker.core.data.datasource.local.dao.SavedTicketDao
import com.example.binance_ticker.core.data.repository.SavedTicketRepositoryImpl
